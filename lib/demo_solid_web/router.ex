defmodule DemoSolidWeb.Router do
  use DemoSolidWeb, :router
  ...
  if Application.compile_env(:demo_solid, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: DemoSolidWeb.Telemetry
